...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "A collection of my research and industry projects in ML systems, multimodal learning, and production ML infrastructure.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-biometric-eye-recognition-system",
          title: 'Biometric Eye Recognition System',
          description: "CNN-based segmentation for vascular-feature identification",
          section: "Projects",handler: () => {
              window.location.href = "/projects/4_project/";
            },},{id: "projects-kubernetes-security-assessment",
          title: 'Kubernetes Security Assessment',
          description: "Security audit and tool benchmarking for Adobe&#39;s K8s infrastructure",
          section: "Projects",handler: () => {
              window.location.href = "/projects/5_project/";
            },},{id: "projects-data-tracking-amp-alert-automation-system",
